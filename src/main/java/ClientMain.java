...
public class ClientMain {
    ...
    // javac -cp ../resources/client.jar ClientMain.java

    // java -cp ../resources/client.jar;. ClientMain 12345 1000
	...
	public static void main(String[] args) throws Exception{
		...
		File downloadFolder = new File("../resources/client_downloads");
		...
		File uploadFolder = new File("../resources/client_to_store");
